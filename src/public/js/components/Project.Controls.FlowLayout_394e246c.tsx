        ...
        .internal-fsb-element.translucent(style={'paddingBottom': '8px', 'paddingLeft': '10px', 'paddingRight': '10px', 'paddingTop': '8px', 'width': '100%'}, internal-fsb-guid="cc38545a")
          .internal-fsb-element(style={'float': 'right', 'paddingLeft': '5px', 'paddingRight': '0px'}, internal-fsb-guid="36088ed2")
            Button.btn.btn-primary.btn-sm.internal-fsb-element(style={'marginBottom': '3px', 'paddingBottom': '3px', 'paddingTop': '3px', 'width': '100%'}, type="button", onClick=this.onButtonClick_bbb5bbc7.bind(this), internal-fsb-guid="bbb5bbc7")
              .internal-fsb-element(style={'fontSize': '12.5px'}, dangerouslySetInnerHTML={__html: loc('Use Best Experience')}, internal-fsb-guid="bbb5bbc7-text")
            Button.btn.btn-secondary.btn-sm.internal-fsb-element(style={'paddingBottom': '3px', 'paddingTop': '3px', 'width': '100%'}, type="button", onClick=this.onButtonClick_d5430960.bind(this), internal-fsb-guid="d5430960")
              .internal-fsb-element(style={'fontSize': '12.5px'}, dangerouslySetInnerHTML={__html: loc('Close')}, internal-fsb-guid="d5430960-text")
          .internal-fsb-element(style={'MsOverflowX': 'hidden', 'MsOverflowY': 'auto', 'color': 'rgba(85, 85, 85, 1)', 'fontSize': '12.5px', 'fontWeight': '500', 'lineHeight': '1em', 'maxHeight': '57px', 'overflowX': 'hidden', 'overflowY': 'auto', 'paddingBottom': '3px', 'paddingRight': '15px', 'paddingTop': '3px'}, internal-fsb-guid="40dc802d")
            .internal-fsb-element(style={'display': 'inline'}, dangerouslySetInnerHTML={__html: loc('Your privacy is important to us, and we respect your privacy regarding any information we may collect. By accessing this website, you are agreeing to be bound by terms of service, all applicable laws and regulations, and be responsible for compliance with any applicable local laws. Otherwise, you are prohibited from using or accessing this website. All materials used in this website are protected by applicable copyright and trademark law.')}, internal-fsb-guid="b9b3c84b")
