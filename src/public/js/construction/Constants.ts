...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST = [['iframe', 'src', '{', '}'], ['a', 'href', '{', '}'], ['svg', 'dangerouslySetInnerHTML', '{{__html: CodeHelper.toSecuredDataString(', ')}}'], ['input', 'defaultValue', '{', '}'], ['textarea', 'defaultValue', '{', '}'], ['select', 'defaultValue', '{', '}'], ['img', 'src', '{', '}'], ['video', 'src', '{', '}']];
...
export const DOT_NOTATION_CONSUMABLE_TAG_LIST_FALLBACK = [['iframe', 'src', '', ''], ['a', 'href', '', ''], ['svg', '__INLINE__', '#{', '}'], ['input', 'value', '', ''], ['textarea', 'value', '', ''], ['select', 'value', '', ''], ['img', 'src', '', ''], ['video', 'src', '', '']];
export const DOT_NOTATION_CONSUMABLE_CLASS_LIST_FALLBACK = [['HTML', '__INLINE__', '#{', '}'], ['TextElement', '__INLINE__', '#{', '}']];
export const DOT_NOTATION_CONSUMABLE_TAG_DIVISIVE_SKIPPING_LIST = ['a'];
